	    ...
	    if p and f and self.validPath(p+"\\"+f):
                ...
                try:
                    ...
                    if results:
                        for func in results:
                            f.write(str(func) + "\n")
			outputPath = IDA_PRO_TEXT_EXTRACTOR_EXTRACTION_PATH + IDA_PRO_TEXT_EXTRACTOR_EXTRACTED_FILE
                    
                        print "Status: Features file saved in " + os.path.normpath(outputPath)
                except:
